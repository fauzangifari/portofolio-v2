                  ...
                  <li>
                    <div className="list_inner">
                      ...
                      <div className="short">
                        <h3>Email</h3>
                        <span>
                          <a href="mailto:fauzan.gifari30@gmail.com">fauzan.gifari30@gmail.com</a>
                        </span>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="list_inner">
                      ...
                      <div className="short">
                        <h3>Instagram</h3>
                        <span>
                          <a href="https://instagram.com/fauzangfri" target="_blank" rel="noreferrer">@fauzangfri</a>
                        </span>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="list_inner">
                      ...
                      <div className="short">
                        <h3>Github</h3>
                        <span>
                          <a href="https://github.com/fauzangifari" target="_blank" rel="noreferrer">fauzangifari</a>
                        </span>
                      </div>
                    </div>
                  </li>
